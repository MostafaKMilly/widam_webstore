...
const PaymentMethods: React.FC = () => {
  const paymentMethods = [
    ...
    },
    {
      ...
      alt: "Mastercard",
      className: "object-contain shrink-0 self-start w-20",
    },
    { text: "Cash", className: "text-2xl font-semibold text-sky-900" },
    {
  ...
  return (
    <div className="flex flex-wrap gap-5 justify-center text-2xl font-semibold text-sky-900 whitespace-nowrap">
